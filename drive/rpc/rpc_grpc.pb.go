...
// UnimplementedRpcProtoServer must be embedded to have
...
func (UnimplementedRpcProtoServer) testEmbeddedByValue()                  {}
...
func RegisterRpcProtoServer(s grpc.ServiceRegistrar, srv RpcProtoServer) {
	// If the following call pancis, it indicates UnimplementedRpcProtoServer was
